...
public class DocumentComparisonStats extends javaxt.sql.Model {
    ...
    public DocumentComparisonStats() {
        super("application.document_comparison_stats", java.util.Map.ofEntries(
                ...
                java.util.Map.entry("test", "test_id"), java.util.Map.entry("a", "a_id"),
                java.util.Map.entry("b", "b_id"), java.util.Map.entry("t", "t"),
                java.util.Map.entry("a_size", "a_size"), java.util.Map.entry("b_size", "b_size"),
                java.util.Map.entry("pyTotalDec", "py_total_dec"),
                java.util.Map.entry("pyPagesPerSec", "py_pages_per_sec"),
                java.util.Map.entry("pyReadPdf", "py_read_pdf"), java.util.Map.entry("pyPostProc", "py_post_proc"),
                java.util.Map.entry("pyElapsedTime", "py_elapsed_time"), java.util.Map.entry("info", "info")
    ...
    protected void update(Object rs) throws SQLException {
        ...
        try {
            ...
            final Long testID = getValue(rs, "test_id").toLong();
            final Long aID = getValue(rs, "a_id").toLong();
            final Long bID = getValue(rs, "b_id").toLong();
            ...
            // Set test
            if (testID != null) {
                test = new DocumentComparisonTest(testID);
            }
    ...
    // **************************************************************************
    /**
     * Used to find a DocumentComparisonStats using a given set of constraints.
     * Example: DocumentComparisonStats obj =
     * DocumentComparisonStats.get("test_id=", test_id);
     */
    public static DocumentComparisonStats get(Object... args) throws SQLException {
        final Object obj = _get(DocumentComparisonStats.class, args);
    ...
    public static DocumentComparisonStats[] find(Object... args) throws SQLException {
        final Object[] obj = _find(DocumentComparisonStats.class, args);
        final DocumentComparisonStats[] arr = new DocumentComparisonStats[obj.length];
